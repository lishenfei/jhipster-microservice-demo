...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "jhipsterMicroserviceDemo@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "jhipsterMicroserviceDemo API";

        private String description = "jhipsterMicroserviceDemo API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "jhipsterMicroserviceDemo";
